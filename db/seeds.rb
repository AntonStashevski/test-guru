...
test1 = Test.create(title: 'PHP', difficulty: 1, category_id: category1.id)
test2 = Test.create(title: 'RubyOnRails', difficulty: 2, category_id: category1.id)
test3 = Test.create(title: 'CSS', difficulty: 0, category_id: category2.id)
test4 = Test.create(title: 'HTML', difficulty: 0, category_id: category2.id)
test5 = Test.create(title: 'Python', difficulty: 1, category_id: category3.id)
...
Result.create(test_id: test1.id, user_id: user1.id)
Result.create(test_id: test2.id, user_id: user1.id)
Result.create(test_id: test3.id, user_id: user1.id)
Result.create(test_id: test4.id, user_id: user2.id)
Result.create(test_id: test5.id, user_id: user2.id)
Result.create(test_id: test1.id, user_id: user3.id)
